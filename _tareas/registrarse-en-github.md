...
Tanto si te han concedido los descuentos como si no, puedes proceder con la tarea [{{ page.next.title}}]({{ page.next.url }}). Obtener los descuentos no es necesario para poder hacer el resto de tareas.
